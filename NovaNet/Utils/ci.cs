...
namespace NovaNet
{
	namespace Utils
	{
		...
		public class ci: Imagery
		{
            ...
            public bool MergePdf(string[] InputFilenames, string pPdfFileName)
            {
                //Return value
                bool retval = false;
                int idxPass = 0;
            ...
            public bool TifToSinglePdf(string InputFilenames, int pJpegQaulityValue, string pPdfFileName)
            {
                //Return value
                bool retval = false;
                int idxPass = 0;
